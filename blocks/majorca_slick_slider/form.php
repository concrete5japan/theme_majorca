...
<div id="ccm-tab-content-options-<?php echo $getString?>" class="ccm-tab-content">
    ...
    <div class="form-group">
        <div class="checkbox">
            <label>
            <?php
            echo $form->checkbox($view->field('fade'), 1, $fade);
            echo t('Enable fade');
            ?>
            </label>
        </div>
    ...
    <div class="form-group">
        <div class="checkbox">
            <label>
            <?php
            echo $form->checkbox($view->field('centerMode'), 1, $centerMode);
            echo t('Enables centered view with partial prev/next slides. Use with odd numbered slidesToShow counts.');
            ?>
            </label>
        </div>
    </div>
    <div class="form-group">
        <?php echo $form->label($view->field('centerPadding'), t('Side padding when in center mode (px)')); ?>
        <div class="input-group" style="width: 150px">
        <?php echo $form->number($view->field('centerPadding'), $centerPadding ? $centerPadding : 50, array('min' => '10', 'max' => '500'))?><span class="input-group-addon"><?php echo t('px'); ?></span>
        </div>
    </div>
    <div class="form-group">
        <?php echo $form->label($view->field('slidesToShow'), t('Number of slide items for Thumbnail Slider Nav. or
Max 4 for Carousel Slider.')); ?>
        <div class="input-group" style="width: 150px">
        <?php echo $form->number($view->field('slidesToShow'), $slidesToShow ? $slidesToShow : 3, array('min' => '1', 'max' => '10'))?>
        </div>
    </div>
    <div class="form-group">
        <div class="checkbox">
            <label>
            <?php
            echo $form->checkbox($view->field('centerModeThumbNav'), 1, $centerModeThumbNav);
            echo t('Center Mode (Thumbnail Slider Nav)');
            ?>
            </label>
        </div>
    </div>
